...
PILLS_WEIGHTS_PATH = "C:/0.encore/19.Final/Mask_RCNN/logs/mask_rcnn_pills_0028.h5"  # TODO: update this path
...
image = load_image("./pills_dataset/test/Esome2.jpg")
...
# class 명 출력
print(dataset.class_names[int(r['class_ids'])])
